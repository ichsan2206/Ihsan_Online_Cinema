...
import Transaksi from '../../assets/Transaction.svg'
  ...
  return (
    ...
    <Container>
        ...
        <NavDropdown
                        ...
                        <NavDropdown.Item style={{backgroundColor: 'black', color: 'white'}} as={Link} to="/admin">
                            <img
                                src={Transaksi}
                                alt="icon"
                        ...
                        <NavDropdown.Item style={{backgroundColor: 'black', color: 'white'}} as={Link} to="/admin/add-film">
                            <img
                                src={MyFilm}
                                alt="icon"
                                style={{ width: '25px', marginRight: '5px' }}
                        ...
                        <NavDropdown.Item style={{backgroundColor: 'black', color: 'white'}} as={Link} to="/admin/compain-admin">
                            <img
                                src={Chat}
                                alt="icon"
                                style={{ width: '25px', marginRight: '5px' }}
